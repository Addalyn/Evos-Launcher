...
export default function TopGamesDeathsByAvgDESC() {
  ...
  const options = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: t('stats.top20DeathsAvgDESC'),
      },
    },
  };
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      data.forEach((item) => {
        ...
        // @ts-ignore
        setGameData((prev) => [...prev, item.average_deaths_per_game]);
      });
    }
